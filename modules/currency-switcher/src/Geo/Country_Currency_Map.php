<?php
/**
 * Static ISO 3166-1 alpha-2 country → ISO 4217 currency map.
 *
 * @package TejCart\Currency_Switcher\Geo
 */

declare(strict_types=1);

namespace TejCart\Currency_Switcher\Geo;
...
/**
 * Hard-coded country→currency lookup used by the IP geolocation
 * fallback. Same dataset shape as the Nexa WC plugin so behaviour is
 * predictable across stores migrating from WooCommerce.
 *
 * Eurozone members all resolve to EUR; UK to GBP; offshore territories
 * follow their de-facto trading currency.
 */
final class Country_Currency_Map {
    /**
     * Lookup the currency code for a country, or null if unknown.
     */
    public static function currency_for( string $country_code ): ?string {
    ...
    public static function map(): array {
        return array(
            ...
            'GP' => 'EUR', 'GQ' => 'XAF', 'GR' => 'EUR', 'GS' => 'GBP', 'GT' => 'GTQ',
            'GU' => 'USD', 'GW' => 'XOF', 'GY' => 'GYD', 'HK' => 'HKD', 'HM' => 'AUD',
            'HN' => 'HNL', 'HR' => 'EUR', 'HT' => 'HTG', 'HU' => 'HUF', 'ID' => 'IDR',
            'IE' => 'EUR', 'IL' => 'ILS', 'IM' => 'GBP', 'IN' => 'INR', 'IO' => 'USD',
            'IQ' => 'IQD', 'IR' => 'IRR', 'IS' => 'ISK', 'IT' => 'EUR', 'JE' => 'GBP',
            'JM' => 'JMD', 'JO' => 'JOD', 'JP' => 'JPY', 'KE' => 'KES', 'KG' => 'KGS',
            'KH' => 'KHR', 'KI' => 'AUD', 'KM' => 'KMF', 'KN' => 'XCD', 'KP' => 'KPW',
            ...
            'UM' => 'USD', 'US' => 'USD', 'UY' => 'UYU', 'UZ' => 'UZS', 'VA' => 'EUR',

<?php
/**
 * Order processing email template (gold-grade, table-based, inline styles).
 *
 * Sent to the customer when their order status changes to processing.
...
<p class="nx-text" style="<?php echo esc_attr( $nx_p_style ); ?>">
    ...
    echo wp_kses_post(
        sprintf(
            ...
            __( 'Your order <strong>#%1$s</strong> placed on <strong>%2$s</strong> is now being processed. We will notify you when it has been completed.', 'tejcart' ),
    ...
    <p class="nx-muted" style="<?php echo esc_attr( $nx_muted_style ); ?>">
        ...
        echo wp_kses_post(
            sprintf(
                ...
                __( 'Payment method: <strong>%s</strong>', 'tejcart' ),
...
<p class="nx-muted" style="<?php echo esc_attr( $nx_muted_style ); ?>">
    <?php esc_html_e( 'We will send you another email when your order is complete.', 'tejcart' ); ?>
</p>
